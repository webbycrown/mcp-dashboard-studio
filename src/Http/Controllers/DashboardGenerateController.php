...
use Webbycrown\McpDashboardStudio\Mcp\Services\DashboardStorageService;
use Webbycrown\McpDashboardStudio\Support\RoutePaths;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Throwable;

class DashboardGenerateController extends Controller
{
    public function generate(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $definition = app(DashboardStorageService::class)->storeSpec($prompt, $specArray);

            // Generate URL from the current live URL base
